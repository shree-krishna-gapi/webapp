    ...
    for ( i = 0; i < item.length; i++) {
      ...
      $("<tr>"+
        ...
        "<td class='text-center'>"+
          ...
          "<input type='number' class='m-text unit' name='unit[]' min='0' id='unit'>"+
        "</td>"+    
        "<td class='text-center'>"+
          "<input type='number' class='m-text pic' name='pic[]' min='0' id='pic'>"+
        "</td>"+   
        "<td class='text-center'>"+
          "<input type='number' class='m-text qty' name='qty[]' min='0' id='qty'>"+
        "</td>"+  
        "<td class='text-center'>"+
